...
public class SWTFactory {
	...
	public static StyledText createStyledText(Composite parent, int style,
			int hspan, int width, int height, int fill) {
	 ...
	 */
	public static Composite createComposite(Composite parent, Font font,
			int style, int columns, int hspan, int fill, int marginwidth,
			int marginheight) {
	...
	public static void showPreferencePage(String id) {
		PreferencesUtil.createPreferenceDialogOn(SpaceBarPlugin.getShell(),
