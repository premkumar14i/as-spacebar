...
public class CreateIndexWizard extends AbstractWizard implements INewWizard {

	private Indexes indexes;
	private Index index;

	public CreateIndexWizard() {
		super("CreateIndex", "Index Creation Error", "Could not add index");
		setWindowTitle("Add Index");
	}

	public CreateIndexWizard(Indexes indexes) {
		this();
