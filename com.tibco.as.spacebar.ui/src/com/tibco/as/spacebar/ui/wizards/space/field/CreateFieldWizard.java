...
public class CreateFieldWizard extends AbstractWizard implements INewWizard {

	private SpaceFields fields;
	private Field field;

	public CreateFieldWizard() {
		super("CreateField", "Field Creation Error", "Could not add field");
		setWindowTitle("Add Field");
	}

	public CreateFieldWizard(SpaceFields fields) {
		this();
		this.fields = fields;
	}
	...
	protected void finish(IProgressMonitor monitor) throws Exception {
		...
		Space space = ((com.tibco.as.spacebar.ui.model.Space) fields.getParent())
				.getSpace();
