...
public class FieldListEditor extends Composite {
	...
	private void remove() {
		for (Object element : ((IStructuredSelection) tableViewer
			...
			fields.removeChild(((Field) element).getName());
		}
		tableViewer.refresh();
	}
	...
	public static void main(String[] args) {
		...
		SpaceFields fields = new SpaceFields(new Space(new Spaces(
				new Metaspace(new Metaspaces(), "ms"), "spaces"),
				SpaceDef.create()), "space");
		Field field1 = new Field(fields, "field1");
		field1.setType(FieldType.DATETIME);
		field1.setNullable(true);
		fields.addChild(field1);
		Field field2 = new Field(fields, "field2");
